...
INSERT INTO timesheets (project_id, user_id, date_from, date_to, duration_min) VALUES
    ...
    (2, 4, TO_DATE('2021/07/14', 'YYYY/MM/DD'), TO_DATE('2021/07/14', 'YYYY/MM/DD'), 480),
    (2, 4, TO_DATE('2021/07/15', 'YYYY/MM/DD'), TO_DATE('2021/07/15', 'YYYY/MM/DD'), 480),
    (2, 4, TO_DATE('2021/07/16', 'YYYY/MM/DD'), TO_DATE('2021/07/16', 'YYYY/MM/DD'), 480),
    (2, 4, TO_DATE('2021/07/19', 'YYYY/MM/DD'), TO_DATE('2021/07/23', 'YYYY/MM/DD'), 2400),
    (1, 4, TO_DATE('2021/07/26', 'YYYY/MM/DD'), TO_DATE('2021/07/26', 'YYYY/MM/DD'), 480),
    (2, 4, TO_DATE('2021/07/27', 'YYYY/MM/DD'), TO_DATE('2021/07/27', 'YYYY/MM/DD'), 480),
    (3, 4, TO_DATE('2021/07/28', 'YYYY/MM/DD'), TO_DATE('2021/07/28', 'YYYY/MM/DD'), 480);
